...
@section('content-home')
    <section class="position-relative" id="about_introduction">
        <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100   light-mode-img"
            data-bg-src="./assets/images/background/bg-about-01.jpg">
        </div>
        <div class="lazy-bg bg-overlay dark-mode-img position-absolute z-index-1 w-100 h-100"
            data-bg-src="./assets/images/banner/banner-white-42.jpg">
        </div>
        <div class="position-relative z-index-2 container py-18 py-lg-25">
            <p class="fw-semibold ls-15 text-uppercase text-body-emphasis mb-lg-7 mt-lg-16">Giới thiệu</p>
            <h2 class="fs-56px mb-7">Về Glowing</h2>
        </div>
    </section>
    <section>
        ...
        <div class="container pt-lg-17 pb-lg-20 pb-15 pt-11 mb-lg-4">
            <div class="text-center pb-lg-17 pb-13 mb-3">
                <img data-src="./assets/images/shop/image-box-01.png" alt="other-02" class="img-fluid lazy-image m-auto"
                    width="150" height="158" src="#" />
                <h3 class="mw-xl-50 mw-lg-60 mx-lg-auto mb-8">Chúng tôi cố gắng sống với lòng trắc ẩn, lòng tốt và sự đồng cảm</h3>
                <p class="mw-xl-60 mw-lg-75 mx-lg-auto mb-0">Rất nhiều cái được gọi là quần denim kéo dài ngoài kia chỉ là quần thể thao được tôn vinh-chúng có được rộng thùng thình và mất hình dạng. Không mát. Vải dệt kim chặt chẽ của chúng tôi giữ hình dạng của nó sau khi mặc nhiều lần. 
                    Thêm vào đó, Alday mặc quần áo lên hoặc xuống, không có prob.
                     Vì vậy, bạn có thể mặc chúng cả ngày. Nhận nó?</p>
            </div>
            <div class="row mb-lg-18 mb-15 pb-3 align-items-center">
                <div class="col-lg-6 pe-lg-0">
                    <div class="card border-0 hover-zoom-in rounded-0">
                        <div class="image-box-4">
                            <img class="lazy-image img-fluid lazy-image w-100" src="#"
                                data-src="./assets/images/banner/banner-11.jpg" width="960" height="640"
                                alt="">
                        </div>
                        <div class="d-none">
                        </div>
                ...
                <div class="col-lg-6 px-lg-12 ps-xl-18 pe-xl-20 mt-12 mt-lg-0">
                    <h3 class="mb-8">Give your skin a healthy glow everyone</h3>
                    <p class="mb-0">Luxe, lightweight, and made with the perfect blend of cashmere and cotton, our Sonoma
                        Pillows and Throws are inspired by the basics we turn to season after season. Get to know the cozy
                        essentials that will elevate your space in an instant.</p>
                </div>
            </div>
                ...
                <div class="col-lg-6 ps-lg-0 order-lg-1">
                    <div class="card border-0 hover-zoom-in rounded-0">
                        <div class="image-box-4">
                            ...
                            <img class="lazy-image img-fluid lazy-image w-100" src="#"
                                data-src="./assets/images/banner/banner-12.jpg" width="960" height="640"
                                alt="">
                        </div>
                        <div class="d-none">
                        </div>
            ...
            <div class="row mb-11 mb-lg-15">
                <div class="col-lg-9 offset-lg-1 col-xl-8 offset-xl-2">
                    <div class="slick-slider main"
                        ...
                        <div class="text-center">
                            <h4 class="mb-0">"Amazing product. The results are so transformative in texture and my face
                                feels plump and healthy. Highly recommend!"</h4>
                        </div>
                        <div class="text-center">
                            <h4 class="mb-0">"Millions of combinations, meaning you get a totally unique piece of
                                furniture exactly the way you want it."</h4>
            ...
            <div class="slick-slider thumb"
                ...
                <div class="client-logo-item">
                    ...
                    <img class="lazy-image w-auto mx-auto opacity-30 light-mode-img" src="#"
                        data-src="./assets/images/client-logo/client-logo-01.png" width="150" height="82"
                        alt="goodness">
                    <img class="lazy-image dark-mode-img w-auto mx-auto opacity-30" src="#"
                        data-src="./assets/images/client-logo/client-logo-white-01.png" width="150" height="82"
                        alt="goodness">
                </div>
                <div class="client-logo-item">
                    ...
                    <img class="lazy-image w-auto mx-auto opacity-30 light-mode-img" src="#"
                        data-src="./assets/images/client-logo/client-logo-02.png" width="150" height="82"
                        alt="grandgolden">
                    <img class="lazy-image dark-mode-img w-auto mx-auto opacity-30" src="#"
                        data-src="./assets/images/client-logo/client-logo-white-02.png" width="150" height="82"
                        alt="grandgolden">
                </div>
                <div class="client-logo-item">
                    ...
                    <img class="lazy-image w-auto mx-auto opacity-30 light-mode-img" src="#"
                        data-src="./assets/images/client-logo/client-logo-03.png" width="150" height="82"
                        alt="parker">
                    <img class="lazy-image dark-mode-img w-auto mx-auto opacity-30" src="#"
                        data-src="./assets/images/client-logo/client-logo-white-03.png" width="150" height="82"
                        alt="parker">
                </div>
                <div class="client-logo-item">
                    ...
                    <img class="lazy-image w-auto mx-auto opacity-30 light-mode-img" src="#"
                        data-src="./assets/images/client-logo/client-logo-04.png" width="150" height="82"
                        alt="thebeast">
                    <img class="lazy-image dark-mode-img w-auto mx-auto opacity-30" src="#"
                        data-src="./assets/images/client-logo/client-logo-white-04.png" width="150" height="82"
                        alt="thebeast">
                </div>
                <div class="client-logo-item">
                    ...
                    <img class="lazy-image w-auto mx-auto opacity-30 light-mode-img" src="#"
                        data-src="./assets/images/client-logo/client-logo-05.png" width="150" height="82"
                        alt="hayden">
                    <img class="lazy-image dark-mode-img w-auto mx-auto opacity-30" src="#"
                        data-src="./assets/images/client-logo/client-logo-white-05.png" width="150" height="82"
                        alt="hayden">
                </div>
                <div class="client-logo-item">
                    ...
                    <img class="lazy-image w-auto mx-auto opacity-30 light-mode-img" src="#"
                        data-src="./assets/images/client-logo/client-logo-06.png" width="150" height="82"
                        alt="goodmood">
                    <img class="lazy-image dark-mode-img w-auto mx-auto opacity-30" src="#"
                        data-src="./assets/images/client-logo/client-logo-white-06.png" width="150" height="82"
                        alt="goodmood">
                </div>
                <div class="client-logo-item">
                ...
                <div class="px-xl-11">
                    <div class="card border-0 hover-change-image ">
                        ...
                        <div class="card-body px-0 py-7 text-start">
                            <h4 class="">
                                <a href="#" class="text-decoration-none">Slava Fedutik</a>
                            </h4>
